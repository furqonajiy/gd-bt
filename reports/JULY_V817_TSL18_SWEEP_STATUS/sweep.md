# July staged TSL18 quality + collision sweep — status

- Run: `28510754898`  objective: `edge_plus_rebate_guarded`
- recent window: `jun_jul`  validation window: `jan_jul`
- Bounded curated grid (quality + collision + combined), NOT a cartesian product.
