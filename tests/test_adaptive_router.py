...
from trading.engine import DEFAULT_CONFIG, StrategyConfig
from trading.engine.cli import _adaptive_enabled, _maybe_adaptive_config
...
def test_champion_config_loads_and_falls_back(tmp_path):
    from trading.engine import champion_config
...
def test_regime_config_resolver_maps_signal_to_champion(tmp_path):
    from trading.engine import make_regime_config_resolver, parse_one_signal
...
def test_run_backtest_calls_config_resolver_per_signal(tmp_path):
    ...
    from trading.engine import (CsvChartSource, parse_signals_file, run_backtest,
                                StrategyConfig)
    import textwrap
