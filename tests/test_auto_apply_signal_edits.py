...
from trading.engine import DEFAULT_CONFIG, ExecutionLog, SignalRegistry, parse_one_signal
...
def harness(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("trading.engine.mt5_equity", lambda conn: 5000.0)
