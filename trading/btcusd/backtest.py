...
use, and writes an Excel report. Refuses to run until trading.btcusd.strategy is
...
trading.btcusd.strategy config is never mutated for a research run).

PowerShell (conda env `trading`):
    python -m trading.btcusd.backtest --charts "data/BTCUSD_M1_*_ELEV8.csv" --output reports/btc_self
"""
