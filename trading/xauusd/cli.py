...
from trading.xauusd import ManualPositionSource, StrategyConfig
from trading.xauusd import parse_signals_file as _default_parse_signals_file
from trading.xauusd import decide as _default_decide
...
def _maybe_adaptive_config(args: argparse.Namespace, base_config: StrategyConfig,
    ...
    from trading.xauusd import champion_config, read_current_regime
