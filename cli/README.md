...
| `v072` | `candidate_V072_victor_trailing_combo.txt` | **Victor combined trailing** (tag V072) — V017 base with the FIVE best single-knob levers stacked (open0.25 / TP3 / slm1.6 / gap0.7 / mh180) from the July Victor trailing-geometry sweep: pure P&L **+36.7% vs V017** on May+June ticks ($152.7k vs $111.7k) at **flat DD 14.07%**, win 44.8%. **RESEARCH — demo-validate** (in-sample, mixed tick/M1 so gate-excluded, 5 knobs at once; OOS unproven) |
